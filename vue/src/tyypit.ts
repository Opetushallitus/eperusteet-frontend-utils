...
export type NavigationNodeType =
  ...
  | 'vuosiluokkakokonaisuus' | 'perusopetusoppiaine' | 'perusopetuspaikallinenoppiaine' | 'valinnaisetoppiaineet' | 'perusopetusOppiaineet' | 'oppiaineenvuosiluokka' | 'paikallinenoppiainevuosiluokka'
